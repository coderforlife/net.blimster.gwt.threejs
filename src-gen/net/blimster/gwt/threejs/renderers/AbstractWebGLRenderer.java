 ...
 */
public abstract class AbstractWebGLRenderer extends Renderer
{
	
	protected AbstractWebGLRenderer()
	{
		super();
	}
	...
	public final native void clear(boolean color, boolean depth, boolean stencil)
	/*-{
