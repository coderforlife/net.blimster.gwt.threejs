 ...
 */
public final class ParticleSystem extends Object3D
{
	...
	public static native ParticleSystem create(Geometry geometry, Material material)
	/*-{
	...
	public final native void setSortParticles(boolean sortParticles)
	/*-{
	...
	public final native boolean getSortParticles()
	/*-{
