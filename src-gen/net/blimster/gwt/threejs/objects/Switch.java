 ...
 */
public final class Switch extends Object3D
{
	...
	public static native Switch create(JsArray<Object3D> children, Object3D selected)
	/*-{
		
		return new $wnd.THREE.Switch(children, selected);
		
	}-*/;
	
	
	
	public final native void select(Object3D child)
	/*-{
