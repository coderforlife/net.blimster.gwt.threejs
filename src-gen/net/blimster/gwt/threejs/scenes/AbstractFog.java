 ...
 */
public abstract class AbstractFog extends Object3D
{
	
	protected AbstractFog()
	{
		super();
	}
	
	
	public static native AbstractFog create()
	/*-{
		
		return new $wnd.THREE.AbstractFog();
		
	}-*/;
	
	
	
	public static native AbstractFog create(Color color)
	/*-{
		
		return new $wnd.THREE.AbstractFog(color);
