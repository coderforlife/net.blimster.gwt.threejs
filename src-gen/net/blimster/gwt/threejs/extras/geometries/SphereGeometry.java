...
public final class SphereGeometry extends Geometry
{
	...
	public static native SphereGeometry create(double radius, int segmentsWidth, int segmentsHeight)
	/*-{
		
		return new $wnd.THREE.SphereGeometry(radius, segmentsWidth, segmentsHeight);
