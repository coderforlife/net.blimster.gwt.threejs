...
public final class Color extends JavaScriptObject
{
	...
	public static native Color create(int value)
	/*-{
		
		return new $wnd.THREE.Color(value);
	...
	public final native Color multiply(Color withColor)
	/*-{
		
		return this.multiply(withColor);
